...
| `GET /lookup.php?i=<id>` | Fetch full recipe detail by ID *(Phase 5)* |
...
Test infrastructure:
- **`bloc_test`** — BLoC/Cubit unit testing utilities
- **`mocktail`** — mock generation without code gen

> Tests for use cases, BLoC layers, and key widgets are planned for Phase 8.
...
| 2 | Base architecture (DI, routing, theme, networking) | ✅ Done |
| 3 | Categories feature | ✅ Done |
| 4 | Recipe browsing & search | ✅ Done |
| 5 | Recipe detail screen | ⏳ Pending |
| 6 | Voice-driven search | ✅ Done |
| 7 | Bonus features (favourites, share, hero animations…) | ☐ Upcoming |
| 8 | Testing & verification | ☐ Upcoming |
| 9 | Build, demo, submission | ☐ Upcoming |

---

## 📄 License

This project was built as part of a Flutter developer assignment. All recipe data is provided by [TheMealDB](https://www.themealdb.com) under their free-tier terms.
