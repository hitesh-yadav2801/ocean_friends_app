...
final class NetworkFailure extends Failure {
  const NetworkFailure({String message = 'No internet connection. Please check your network and try again.'})
      : super(message);
}
...
final class CacheFailure extends Failure {
  const CacheFailure({String message = 'Local storage error. Please try again.'})
      : super(message);
}
